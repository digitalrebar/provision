...
`
var isosDestroyNoArgsErrorString = "Error: rscli isos destroy [id] requires 1 argument\n"
var isosDestroyTwoArgsErrorString = "Error: rscli isos destroy [id] requires 1 argument\n"
