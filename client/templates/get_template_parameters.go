...
func (o *GetTemplateParams) WithUUID(uuid string) *GetTemplateParams {
	o.SetUUID(uuid)
	return o
}

// SetUUID adds the uuid to the get template params
func (o *GetTemplateParams) SetUUID(uuid string) {
	o.UUID = uuid
}
