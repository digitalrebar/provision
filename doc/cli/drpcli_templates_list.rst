...
This will list all templates by default.
...
-  ID=Lt(fred)&Available=true - returns items with Name less than fred
   and Available is true

::

    drpcli templates list [key=value] ... [flags]
