drpcli async_action_templates wait
----------------------------------

Wait for a async_action_template’s field to become a value within a
number of seconds
...
::
   ...
   drpcli async_action_templates wait [id] [field] [value] [timeout] [flags]
