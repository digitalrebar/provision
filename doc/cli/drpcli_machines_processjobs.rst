...
::
         ...
         --context string     Execution context this agent should pay attention to jobs in
         --exit-on-failure    Exit on failure of a task
     -h, --help               help for processjobs
         --oneshot            Do not wait for additional tasks to appear
         --skip-power         Skip any power cycle actions
         --state-dir string   Location to save agent runtime state
