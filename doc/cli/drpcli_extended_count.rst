...
This will count all by default. You can narrow down the count returned
using index filters. Use the “indexes” command to get the indexes
available for .
...
::
   ...
   drpcli extended count [filters...] [flags]
