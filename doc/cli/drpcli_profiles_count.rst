...
This will count all profiles by default. You can narrow down the count
returned using index filters. Use the “indexes” command to get the
indexes available for profiles.
...
::
   ...
   drpcli profiles count [filters...] [flags]
