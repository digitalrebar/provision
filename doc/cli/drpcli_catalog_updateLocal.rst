...
::
         ...
         --concurrency int   Number of concurrent download options (default 1)
     -h, --help              help for updateLocal
         --tip               Include tip versions of the packages
         --version string    Minimum version of the items. If set to 'stable' will only get stable entries.
