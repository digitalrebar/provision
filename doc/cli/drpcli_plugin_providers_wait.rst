drpcli plugin\_providers wait
=============================

Wait for a plugin\_provider's field to become a value within a number of
seconds
...
::
    ...
    drpcli plugin_providers wait [id] [field] [value] [timeout] [flags]
