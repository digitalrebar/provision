drpcli async_action_templates count
-----------------------------------

Count all async_action_templates

Synopsis
~~~~~~~~

This will count all async_action_templates by default. You can narrow
down the count returned using index filters. Use the “indexes” command
to get the indexes available for async_action_templates.
...
::
   ...
   drpcli async_action_templates count [filters...] [flags]
