...
This will count all tenants by default. You can narrow down the count
returned using index filters. Use the “indexes” command to get the
indexes available for tenants.
...
::
   ...
   drpcli tenants count [filters...] [flags]
