drpcli async_action_templates list
----------------------------------

List all async_action_templates

Synopsis
~~~~~~~~

This will list all async_action_templates by default. You can narrow
down the items returned using index filters. Use the “indexes” command
...
::
   ...
   drpcli async_action_templates list [filters...] [flags]
