...
This will count all contexts by default. You can narrow down the count
returned using index filters. Use the “indexes” command to get the
indexes available for contexts.
...
::
   ...
   drpcli contexts count [filters...] [flags]
