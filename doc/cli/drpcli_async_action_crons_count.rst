drpcli async_action_crons count
-------------------------------

Count all async_action_crons

Synopsis
~~~~~~~~

This will count all async_action_crons by default. You can narrow down
the count returned using index filters. Use the “indexes” command to get
the indexes available for async_action_crons.
...
::
   ...
   drpcli async_action_crons count [filters...] [flags]
