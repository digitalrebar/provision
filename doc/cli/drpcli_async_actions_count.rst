...
This will count all async_actions by default. You can narrow down the
count returned using index filters. Use the “indexes” command to get the
indexes available for async_actions.
...
::
   ...
   drpcli async_actions count [filters...] [flags]
