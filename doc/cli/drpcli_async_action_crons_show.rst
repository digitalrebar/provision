drpcli async_action_crons show
------------------------------

Show a single async_action_crons by id

Synopsis
~~~~~~~~

This will show a async_action_cron by ID. You may also show a single
item using a unique index. In that case, format id as *index*:*value*

::

   drpcli async_action_crons show [id] [flags]
