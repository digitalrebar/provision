...
This will count all bootenvs by default. You can narrow down the count
returned using index filters. Use the “indexes” command to get the
indexes available for bootenvs.
...
::
   ...
   drpcli bootenvs count [filters...] [flags]
