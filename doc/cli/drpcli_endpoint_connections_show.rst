drpcli endpoint_connections show
--------------------------------

Show a single endpoint_connections by id

Synopsis
~~~~~~~~

This will show a endpoint_connection by ID. You may also show a single
item using a unique index. In that case, format id as *index*:*value*

::

   drpcli endpoint_connections show [id] [flags]
