drpcli stages params
--------------------

Gets/sets all parameters for the stage

Synopsis
~~~~~~~~

A helper function to return all or set all the parameters on the stage

::

   drpcli stages params [id] [json] [flags]
