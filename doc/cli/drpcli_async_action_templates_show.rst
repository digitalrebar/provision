drpcli async_action_templates show
----------------------------------

Show a single async_action_templates by id

Synopsis
~~~~~~~~

This will show a async_action_template by ID. You may also show a single
item using a unique index. In that case, format id as *index*:*value*

::

   drpcli async_action_templates show [id] [flags]
