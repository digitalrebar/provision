drpcli async_actions show
-------------------------

Show a single async_actions by id

Synopsis
~~~~~~~~

This will show a async_action by ID. You may also show a single item
using a unique index. In that case, format id as *index*:*value*

::

   drpcli async_actions show [id] [flags]
