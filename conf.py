...
html_title = "Digital Rebar Provision Docs"

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = "DR Prov"
...
man_pages = [
    (master_doc, 'dr-provision', u'Digital Rebar Provision Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Digital Rebar Provision', u'Digital Rebar Provision Documentation',
     author, 'Digital Rebar Provision', 'Golang API-Driven PXE Provisioning & DHCP.',
     'Miscellaneous'),
]
...
urls=[
    "https://s3-us-west-2.amazonaws.com/rebar-catalog/docs/ansible.rst",
    ...
    "https://s3-us-west-2.amazonaws.com/rebar-catalog/docs/image-builders.rst",
    ...
    "https://s3-us-west-2.amazonaws.com/rebar-catalog/docs/sledgehammer-builders.rst",
